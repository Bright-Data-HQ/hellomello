# Email Thread: Hellomello ↔ Bright Data (SEO Engagement)

Chronological log of correspondence. Each entry is tagged with date, sender, and topics so it can be searched/quoted later ("what did we say about X on date Y").
...
- New Hellomello homepage mockup (Canva): https://canva.link/ah286nnf2gpv5ut
- Kickoff & Build Phase Plan meeting notes (2026-05-15 12:00 AEST, Gemini): https://drive.google.com/open?id=1U43G8iygGwBP5hVik8OG5QpNshkaMEy4Hzkfsdr8AC4

---

## 2026-05-13 (Wed, 15:27) — Rod → Vahid
**Topics:** pre-onboarding questions, pSEO quote, blog quote, TGA constraints, hours reallocation, in-house tech SEO

Clarifying questions before Friday onboarding:
1. Rough quote for **further pSEO template design**.
2. Quote for **BLOG article centre / article layout** design.
3. **Months 3–6 alignment** — TGA constraints flagged:
   - Core condition hubs (chronic pain, PTSD) — restricted
   - Treatment types — restricted
   - Product comparison — restricted
   - Eligibility — needs care
   - Asks what the focus of this period should be, and how the 15 hours will be used.
   - If it's purely content rollout, suggests **shifting hours from content to digital/website optimisation** (CRO, form updates, flows).
4. Flags that Hellomello's internal team has been doing **technical SEO fixes** — asks if this impacts month 1 fee/engagement.

---

## 2026-05-13 (Wed, 17:06) — Vahid → Rod
**Topics:** pSEO quote, blog quote, TGA strategy, hours justification, tech SEO overlap

Responses to Rod's pre-onboarding questions:

1. **Additional pSEO template:** ~$1,000–$1,500 ex GST, depending on overlap with the first template.
2. **Blog article centre + article layout:** ~$1,500–$2,500 ex GST.
3. **TGA alignment:** multiple angles to work through, not just condition-led:
   - How the service works (telehealth flow, script pathway, costs, Medicare/PBS)
   - Practitioner-led location pages
   - Trust and credentials hubs
   - General health information
   - Check what competitors are doing; if condition-led is live and unchallenged, that's a workable signal.
   - Best discussed properly in discovery call.
4. **15 hours reallocation:** can shift to website/CRO if there's room, but cautions that pSEO content work is more than generation — it includes analytics review, monitoring indexing/traffic/rankings, and feeding learnings back into templates/topic strategy (the technical layer that makes pSEO work).
5. **In-house tech SEO:** good to hear; Bright Data will review when work begins. Notes there are usually other technical aspects affecting indexing/site flow (indexing, schema, architecture). Will flag further changes once reviewed. Notes Bright Data tends to do more for clients than charged for.

---

## 2026-05-15 (Fri, 16:52) — Vahid → Rod, Alex
**Topics:** onboarding recap, asset request, benchmarking, Meta access

Recap of onboarding meeting. Requests from Bright Data before audit begins:
- Current brand guidelines and assets
- Meta ad account access
- A handful of global telehealth names to benchmark against

Next step: once received, Bright Data will start the audit and return with the strategy doc.

---

## 2026-05-18 (Mon, 12:11) — Rod → Vahid, Alex
**Topics:** acknowledgement

Confirms he will send the requested items ASAP.

---

## 2026-05-21 (Thu, 22:18) — Rod → Vahid, Alex
**Topics:** brand assets delivered, competitor list, homepage mockup review, Meta partner ID request

Delivers requested items:
- Brand guidelines and assets attached.
- Competitors: refers to the SEO Handover document (competitors page) for additional names.
- Homepage mockup link shared — asks Bright Data to review for SEO before go-live as part of initial strategy review.
- Meta ad account: asks Vahid to confirm Bright Data's **Partner ID** to add them as a partner agency.

---

## 2026-05-22 (Fri, 12:31) — Vahid → Rod, Alex
**Topics:** Meta Partner ID, strategy review confirmation, next meeting

- Confirms Bright Data will review assets, handover doc, and homepage mockup as part of the strategy review.
- **Meta Business Partner ID: 829730115341349**
- Will arrange a call mid next week to walk through progress.

---

## 2026-05-22 (Fri, 12:37) — Rod → Vahid, Alex
**Topics:** Meta access confirmed

Confirms Meta partner access is now done.

---

## 2026-05-26 (Tue, 07:44) — Vahid → Rod
**Topics:** meeting request, agenda, calendar slots

Proposes a Friday catch-up. Agenda:
- Walk through action items and what's been closed off
- Content approval process for new content going live
- pSEO landing page design process

Offered times (AEST Brisbane, GMT+10, **Fri 2026-05-29**):
- 10:00 – 10:45 AM
- 2:00 – 2:45 PM

Booking link: https://calendar.google.com/calendar/appointments/schedules/AcZssZ0qaQ78Pm1oN9JwGxZXOuk9iMrmP9uZ2B0GppYT2qMwV1cOildztGoNHdGuNwM5Za6ZWU6JYN1c?adhocv2=true

---

## 2026-05-26 (Tue, 10:54) — Rod → Vahid
**Topics:** meeting confirmation, strategy expectations, success metrics

- Accepts **10am Friday**.
- Wants alignment before pivoting to tactics (pSEO). Asks to see:
  - Strategy research
  - Competitor analysis
  - Other relevant data informing the approach
- Asks to **jointly agree on success metrics**:
  - What metrics matter
  - Before/after baselines
  - Whether the work translates to tangible results
  - Expected timeline for results

---

## 2026-05-27 (Wed, 13:13) — Vahid → Rod
**Topics:** Friday agenda confirmation, competitor analysis status

- Confirms he will walk Rod through the **audit and strategy doc** on Friday.
- On competitor analysis: a **full version is currently in progress** and will be ready before moving into tactics.
- All other points (success metrics, strategy-before-tactics) will be covered on Friday.

---

## 2026-05-27 (Wed, 13:39) — Rod → Vahid
**Topics:** acknowledgement
...
## 2026-05-28 (Thu) — Rod → Vahid
**Topics:** pre-meeting prep, SEO handover doc, meta tags, competitor summary, homepage mockup

Sent ahead of the Friday meeting:
- **SEO Handover document** prepared, showing:
  - Status of recent SEO works performed on the site
  - Recommended META tags (for Vahid's review)
  - Competitor summary
- **Homepage mockup** link shared again, asking Vahid's team to review for SEO before go-live.
...
| Item | Owner | Status |
|---|---|---|
| Quote: extra pSEO template ($1–1.5k ex GST) | Vahid | Quoted 2026-05-13 |
| Quote: blog article centre ($1.5–2.5k ex GST) | Vahid | Quoted 2026-05-13 |
| TGA-safe content strategy | Vahid | To discuss at Fri 2026-05-29 meeting |
| Reallocate content hours → CRO/website | Both | Open — Vahid cautioned against full shift |
| Review in-house tech SEO work | Vahid | Pending engagement start |
| Brand guidelines + assets | Rod | Delivered 2026-05-21 |
| Competitor list (via SEO Handover) | Rod | Delivered 2026-05-21 |
| Homepage mockup SEO review | Vahid | Pending |
| Meta partner access (ID 829730115341349) | Both | Granted 2026-05-22 |
| Audit + strategy doc presentation | Vahid | Confirmed for Fri 2026-05-29 (per 2026-05-27 reply) |
| Full competitor analysis | Vahid | In progress — to be delivered before tactics phase |
...
- **Bright Data Meta Business Partner ID:** 829730115341349
- **Engagement model:** 15 hours/month; months 3–6 focus under discussion
- **TGA constraints:** no chronic pain / PTSD / treatment-type / product-comparison content; eligibility content needs care
- **Pricing quotes on file:**
  - Extra pSEO template: $1,000–$1,500 ex GST
