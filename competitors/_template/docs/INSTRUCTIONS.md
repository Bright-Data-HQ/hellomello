...
2. Drop SEMrush CSV exports into `<competitor>/data/raw/` (see §3 for required + optional files)
...
competitors/
  _template/
    ...
    docs/                      ← INSTRUCTIONS, DATA_AUDIT, DATA_PREPARATION
    presentation/
